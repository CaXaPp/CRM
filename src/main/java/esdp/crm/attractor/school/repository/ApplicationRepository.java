...
public interface ApplicationRepository extends JpaRepository<Application, Long> {
    ...
    List<Application> findAllActiveOperationsByFunnelId(@Param("id") Long id, @Param("status1") String status1, @Param("status2") String status2);
    ...
    List<Application> getAllActiveOperationsByEmployeeIdAndFunnelId(@Param("userId") Long userId, @Param("funnelId") Long funnelId, @Param("status1") String status1, @Param("status2") String status2);
    ...
    List<Application> findAllNotActiveOperationsByFunnelId(@Param("id") Long id, @Param("status1") String status1, @Param("status2") String status2);
    ...
    List<Application> getAllNotActiveOperationsByEmployeeIdAndFunnelId(@Param("userId") Long userId, @Param("funnelId") Long funnelId, @Param("status1") String status1, @Param("status2") String status2);
    ...
    List<Application> findOperationsByFunnel(@Param("statuses") List<ApplicationStatus> statuses);
    ...
    List<Application> findAllActiveApplicationForToday(@Param("status1") String status1, @Param("status2") String status2);
    ...
    List<Application> findAllActiveApplicationForTodayByUserId(@Param("status1") String status1, @Param("status2") String status2, @Param("userId") Long userId);
    ...
    List<Application> findAllFailureApplicationByUserId(@Param("userId") Long userId);
